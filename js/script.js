...
function displayProducts() { // insetindo colunas, com respectivos conteudos, e um botão de remover
    ...
    products.forEach(function (product) {
        ...
        cell1.innerHTML = `<input type="checkbox" onclick="comprado(this)">` + product.name;
